...
**Galaxy_merger_sample_file.csv** – This file contains the list of galaxy mergers (with RA/Dec coordinates) included in our Fermi-LAT gamma-ray analysis. The galaxy mergers were collected from the following eight catalogs: 
...
**Preprocessing_Summary.txt** – This file summarizes the results obtained from analyzing the selected 1,875 galaxy mergers in this work.
